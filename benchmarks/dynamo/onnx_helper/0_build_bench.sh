...
USE_CUDA=1 python setup.py develop --cmake
...
# TODO: PyTorch cannot be too out of sync, since deps are pulled from main
# and built from source.
# This issue is gone once onnx bench script is in main.
make pull-deps
