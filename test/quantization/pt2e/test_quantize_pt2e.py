...
class TestQuantizePT2E(QuantizationTestCase):
    ...
    def _verify_symmetric_qnnpack_qat_numerics(
        ...
        def insert_print_mod(mod, model_name, node_name):
            print_mod_attr = "print_mod_" + model_name + "_" + node_name
        ...
        model_fx.activation_post_process_31 = copy.deepcopy(model_pt2e.activation_post_process_51)

        #insert_print_mod(model_pt2e, "PT2", "activation_post_process_50")
