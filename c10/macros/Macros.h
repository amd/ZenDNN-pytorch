...
#define C10_DIAGNOSTIC_PUSH_AND_IGNORED_IF_DEFINED(warning)        \
  _C10_PRAGMA(clang diagnostic push)                               \
  _C10_PRAGMA(clang diagnostic ignored "-Wunknown-warning-option") \
  _C10_PRAGMA(clang diagnostic ignored warning)

#define C10_DIAGNOSTIC_POP() _C10_PRAGMA(clang diagnostic pop)

#elif __GNUC__

#define C10_DIAGNOSTIC_PUSH_AND_IGNORED_IF_DEFINED(warning)      \
  _C10_PRAGMA(GCC diagnostic push)                               \
  _C10_PRAGMA(GCC diagnostic ignored "-Wpragmas")                \
  _C10_PRAGMA(GCC diagnostic ignored warning)

#define C10_DIAGNOSTIC_POP() _C10_PRAGMA(GCC diagnostic pop)

#else

#define C10_PUSH_DIAGNOSTIC_IGNORED_IF_DEFINED(warning)
