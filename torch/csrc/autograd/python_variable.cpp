...
static struct PyGetSetDef THPVariable_properties[] = {
    {"_python_dispatch",
     torch::unsafe_cast_function<getter>(THPVariable_get_python_dispatch),
     nullptr,
     nullptr,
     nullptr},
    {"T",
     torch::unsafe_cast_function<getter>(PropertyT::getter),
     nullptr,
     nullptr,
     nullptr},
    {"H",
     torch::unsafe_cast_function<getter>(PropertyH::getter),
     nullptr,
     nullptr,
     nullptr},
    {"mT",
     torch::unsafe_cast_function<getter>(PropertymT::getter),
     nullptr,
     nullptr,
     nullptr},
    {"mH",
     torch::unsafe_cast_function<getter>(PropertymH::getter),
     nullptr,
     nullptr,
     nullptr},
    {"_cdata",
     torch::unsafe_cast_function<getter>(THPVariable_get_cdata),
     nullptr,
     nullptr,
     nullptr},
    {"_version",
     torch::unsafe_cast_function<getter>(THPVariable_get_version),
     nullptr,
     nullptr,
     nullptr},
    {"grad_fn",
     torch::unsafe_cast_function<getter>(THPVariable_get_grad_fn),
     nullptr,
     nullptr,
     nullptr},
    {"_grad_fn",
     torch::unsafe_cast_function<getter>(THPVariable_get_grad_fn),
     torch::unsafe_cast_function<setter>(THPVariable_set_grad_fn),
     nullptr,
     nullptr},
    {"is_leaf",
     torch::unsafe_cast_function<getter>(THPVariable_is_leaf),
     nullptr,
     nullptr,
     nullptr},
    {"retains_grad",
     torch::unsafe_cast_function<getter>(THPVariable_retains_grad),
     nullptr,
     nullptr,
     nullptr},
    {"data",
     torch::unsafe_cast_function<getter>(PropertyData::getter),
     torch::unsafe_cast_function<setter>(THPVariable_set_data),
     nullptr,
     nullptr},
    {"_grad",
     torch::unsafe_cast_function<getter>(PropertyGrad::getter),
     torch::unsafe_cast_function<setter>(THPVariable_set_grad),
     nullptr,
    ...
    {"grad",
     ...
     nullptr},
    {"_base",
     torch::unsafe_cast_function<getter>(THPVariable_get_base),
     nullptr,
     nullptr,
     nullptr},
    {"volatile",
     torch::unsafe_cast_function<getter>(THPVariable_get_volatile),
     torch::unsafe_cast_function<setter>(THPVariable_set_volatile),
     nullptr,
     nullptr},
    {"output_nr",
     torch::unsafe_cast_function<getter>(THPVariable_get_output_nr),
     nullptr,
     nullptr,
     nullptr},
    {"requires_grad",
     torch::unsafe_cast_function<getter>(THPVariable_get_requires_grad),
     torch::unsafe_cast_function<setter>(THPVariable_set_requires_grad),
     nullptr,
     nullptr},
    {"_backward_hooks",
     torch::unsafe_cast_function<getter>(THPVariable_get_backwards_hooks),
     torch::unsafe_cast_function<setter>(THPVariable_set_backwards_hooks),
     nullptr,
     nullptr},
    {"name",
     torch::unsafe_cast_function<getter>(THPVariable_get_name),
     nullptr,
     nullptr,
     nullptr},
    {"shape",
     torch::unsafe_cast_function<getter>(THPVariable_get_shape),
     nullptr,
     nullptr,
     nullptr},
    {"is_cuda",
     torch::unsafe_cast_function<getter>(THPVariable_is_cuda),
     nullptr,
     nullptr,
     nullptr},
    {"is_cpu",
     torch::unsafe_cast_function<getter>(THPVariable_is_cpu),
     nullptr,
     nullptr,
     nullptr},
    {"is_xpu",
     torch::unsafe_cast_function<getter>(THPVariable_is_xpu),
     nullptr,
     nullptr,
     nullptr},
    {"is_ipu",
     torch::unsafe_cast_function<getter>(THPVariable_is_ipu),
     nullptr,
     nullptr,
     nullptr},
    {"is_sparse",
     torch::unsafe_cast_function<getter>(THPVariable_is_sparse),
     nullptr,
     nullptr,
     nullptr},
    {"is_sparse_csr",
     torch::unsafe_cast_function<getter>(THPVariable_is_sparse_csr),
     nullptr,
     nullptr,
     nullptr},
    {"is_mkldnn",
     torch::unsafe_cast_function<getter>(THPVariable_is_mkldnn),
     nullptr,
     nullptr,
     nullptr},
    {"is_mps",
     torch::unsafe_cast_function<getter>(THPVariable_is_mps),
     nullptr,
     nullptr,
     nullptr},
    {"is_ort",
     torch::unsafe_cast_function<getter>(THPVariable_is_ort),
     nullptr,
     nullptr,
     nullptr},
    {"is_vulkan",
     torch::unsafe_cast_function<getter>(THPVariable_is_vulkan),
     nullptr,
     nullptr,
     nullptr},
    {"is_complex",
     torch::unsafe_cast_function<getter>(THPVariable_is_complex),
     nullptr,
     nullptr,
     nullptr},
    {"is_quantized",
     torch::unsafe_cast_function<getter>(THPVariable_is_quantized),
     nullptr,
     nullptr,
     nullptr},
    {"is_meta",
     torch::unsafe_cast_function<getter>(THPVariable_is_meta),
     nullptr,
     nullptr,
     nullptr},
    {"is_nested",
     torch::unsafe_cast_function<getter>(THPVariable_is_nested),
     nullptr,
     nullptr,
     nullptr},
    {"_has_symbolic_sizes_strides",
     torch::unsafe_cast_function<getter>(
         THPVariable_has_symbolic_sizes_strides),
     nullptr,
     nullptr,
     nullptr},
    {"dtype",
     torch::unsafe_cast_function<getter>(THPVariable_dtype),
     nullptr,
     nullptr,
     nullptr},
    {"layout",
     torch::unsafe_cast_function<getter>(THPVariable_layout),
     nullptr,
     nullptr,
     nullptr},
    {"device",
     torch::unsafe_cast_function<getter>(THPVariable_device),
     nullptr,
     nullptr,
     nullptr},
    {"ndim",
     torch::unsafe_cast_function<getter>(THPVariable_get_ndim),
     nullptr,
     nullptr,
     nullptr},
    {"nbytes",
     torch::unsafe_cast_function<getter>(THPVariable_get_nbytes),
     nullptr,
     nullptr,
     nullptr},
    {"itemsize",
     torch::unsafe_cast_function<getter>(THPVariable_get_itemsize),
     nullptr,
     nullptr,
     nullptr},
    {"names",
     torch::unsafe_cast_function<getter>(THPVariable_get_names),
     torch::unsafe_cast_function<setter>(THPVariable_set_names),
     nullptr,
     nullptr},
    {"real",
     torch::unsafe_cast_function<getter>(PropertyReal::getter),
     torch::unsafe_cast_function<setter>(THPVariable_set_real),
     nullptr,
     nullptr},
    {"imag",
     torch::unsafe_cast_function<getter>(PropertyImag::getter),
     torch::unsafe_cast_function<setter>(THPVariable_set_imag),
     nullptr,
     nullptr},
    {nullptr}};
...
PyTypeObject THPVariableType = {
    ...
    torch::unsafe_cast_function<inquiry>(THPVariable_clear), /* tp_clear */
    nullptr, /* tp_richcompare */
    0, /* tp_weaklistoffset */
    nullptr, /* tp_iter */
    nullptr, /* tp_iternext */
...
int THPVariableMetaType_init(PyObject* cls, PyObject* args, PyObject* kwargs) {
  ...
  ((PyTypeObject*)cls)->tp_traverse =
      torch::unsafe_cast_function<traverseproc>(THPVariable_subclass_traverse);
  return 0;
}
