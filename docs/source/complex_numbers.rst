...
.. note:: When using complex32, download the CUDA Toolkit 11.6 package from a pip wheel as described in the `Official CUDA documentation <https://docs.nvidia.com/cuda/cuda-quick-start-guide>`__. 
