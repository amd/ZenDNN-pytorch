...
#ifndef ADEEP_OPERATORS_DECONV_HPP
#define ADEEP_OPERATORS_DECONV_HPP

namespace adeep {

struct convolution_transpose_forward : public zendnn::deconvolution_forward {

  using super = zendnn::deconvolution_forward;
...
struct convolution_transpose_backward_data
    : public zendnn::deconvolution_backward_data {

  using super = zendnn::deconvolution_backward_data;
...
struct convolution_transpose_backward_weights
    : public zendnn::deconvolution_backward_weights {

  using super = zendnn::deconvolution_backward_weights;
